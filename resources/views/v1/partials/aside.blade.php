        ...
        <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-section">
                    <h4 class="menu-text"> {{ __('Access Management - AM -') }} </h4>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text"> {{ __('Legacy') }} </span>
                        <span class="menu-label">
                            <span class="label label-danger label-inline"> {{ __('new') }} </span>
                        </span>
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item menu-item-parent" aria-haspopup="true">
                                <span class="menu-link">
                                    <span class="menu-text"> {{ __('Legacy Access') }} </span>
                                </span>
                            </li>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('legacies.new') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text"> {{ __('New Legacy') }} </span>
                                </a>
                            </li>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a target="_blank" href="{{ route('identity.verification') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="{{ route('contributors') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-section">
                    <h4 class="menu-text"> {{ __('Content Management - CM -') }} </h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text"> {{ __('Memories') }} </span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('memories') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text"> {{ __('Memories') }} </span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('add.memory') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text"> {{ __('New Memory') }} </span>
                                </a>
                            </li>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text"> {{ __('Capsules & CMR') }} </span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item menu-item-parent" aria-haspopup="true">
                                <span class="menu-link">
                                    <span class="menu-text"> {{ __('Capsules & CM') }} </span>
                                </span>
                            </li>

                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('capsules.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text"> {{ __('Cpasules') }} </span>
                                </a>
                            </li>

                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ route('capsules.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text"> {{ __('New Capsule') }} </span>
                                </a>
                            </li>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="{{ route('memories.timeline') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                @php
                    $legacy = App\Models\Legacy::where([
